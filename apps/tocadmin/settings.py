"""
Django settings for tocadmin project.
...
MIDDLEWARE = [
    ...
    'tocadmin.middleware.TimezoneMiddleware',
    'tocadmin.middleware.DemoMiddleware',
    'tocadmin.middleware.RequestMiddleware',
    'orgs.middleware.OrgMiddleware',
]

ROOT_URLCONF = 'tocadmin.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tocadmin.context_processor.tocadmin_processor',
...
# WSGI_APPLICATION = 'tocadmin.wsgi.applications'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            "backupCount": 7,
            'formatter': 'main',
            'filename': os.path.join(PROJECT_DIR, 'logs', 'tocadmin.log')
        },
        'ansible_logs': {
            'level': 'DEBUG',
