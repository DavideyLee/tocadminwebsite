...
class Event(models.Model):
    ...
    solve_even_comment = models.TextField(
        max_length=500, blank=True, verbose_name=_('事件处理方案')
    )
    avoid_even_comment = models.TextField(
        max_length=500, blank=True, verbose_name=_('事件规避方案')
    )